    ...
    <CardWrapper>
      <Card
        ...
        actions={[
          ...
          liked
            ? <HeartFilled key="heart" onClick={onUnlike} />
        ...
        extra={<FollowButton post={post} />} //팔로우 언팔 버튼
      >
            ...
            renderItem={(item) => (
              <li>
                <Comment
                  ...
                  avatar={(
                      <Link href={`/user/${item.User.id}`} prefetch={false}><a><Avatar>{item.User.nickname[0]}</Avatar></a></Link>
                  )}
